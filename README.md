...
- [loadash utility functions](https://www.youtube.com/watch?v=yswr0G3kK14)

#### CLI apps

- [yargs - helps build CLI Apps](https://www.npmjs.com/package/yargs)
- [inquirer - command line interface for Node.js](https://www.npmjs.com/package/inquirer)

#### Performance

- [pm2 - a production process manager for Node.js applications with a built-in load balancer](https://www.npmjs.com/package/pm2)
...
- [Why You Should Learn System Design ASAP (No Matter Your Level](https://zerotomastery.io/blog/why-you-should-learn-system-design-now/)
...
- [Unit Testing Node.js + Mongoose Using Jest](https://plainenglish.io/blog/unit-testing-node-js-mongoose-using-jest-106a39b8393d)
...
- [12 JavaScript Tips & Tricks that I use Every Day + Bonus](https://www.youtube.com/watch?v=wVFr_iy6Ses)
- [Testing Express REST API With Jest & Supertest](https://www.youtube.com/watch?v=r5L1XRZaCR0)
- [ChatGPT Tutorial For Web Developers For Productivity](https://www.youtube.com/watch?v=PBA69caBNeI)
...
- [Codevolution - one stop shop for React](https://www.youtube.com/@Codevolution)
- [Codedamn - Dev in general](https://www.youtube.com/@codedamn)

### Web dev in general

- [Kodaps Academy](https://www.youtube.com/@KodapsAcademy/videos)
